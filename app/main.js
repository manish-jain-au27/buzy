...
function createWindow() {
  ...
  mainWindow.loadURL(
    isDev
        ? 'http://beta.buzy.team/desktopapp/dist/angular-electron' // 'http://beta.buzy.team/desktopapp/dist/angular-electron'
        : 'http://beta.buzy.team/desktopapp/dist/angular-electron' // `file://${path.join(__dirname, 'dist/angular-electron/index.html')}`
  );
